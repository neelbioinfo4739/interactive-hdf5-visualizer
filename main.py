...
def PCA_change(self):
    ...
    js.document.getElementById("pca_matplotlib").style.display = "inline-block"
    js.document.getElementById("tsne_matplotlib").style.display = "none"

# Hide the PCA plot
def TSNE_change(self):
    js.document.getElementById("comment").style.display = "inline-block"
    js.document.getElementById("tsne_matplotlib").style.display = "inline-block"
    js.document.getElementById("pca_matplotlib").style.display = "none"
